...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <a href="logout.php">  <button type="button" class="btn btn-outline-light ml-3">Logout</button> </a> 
      ...
      <!--cards-->
     <section>
          <div class="contaner-fluid back p-4">
          <div class="container">
            <div class="row p-3">
                
            <div class="col-lg-4 col-md-4 col-sm-12 p-3">
              <div class="card sha">
                <img class="card-img-top" src="img/websitews.jpg" alt="Card image cap">
                  <div class="card-body">
                      <h5 class="card-title">Web Development</h5>
                      <p class="card-text text-muted">Design a responsive website easy to handel .</p>
                      <a href="website.php" class="btn btn-success">See More</a>
                </div>
            </div>
                </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 p-3">
                <div class="card sha">
                    <img class="card-img-top" src="img/androids.png" alt="Card image cap">
                         <div class="card-body">
                            <h5 class="card-title">Android App Development</h5>
                             <p class="card-text text-muted">Design a andorid app and solve your problem properly.</p>
                            <a href="android.php" class="btn btn-success">See More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card sha">
                    <img class="card-img-top" src="img/carosel3s.png" alt="Card image cap">
                         <div class="card-body">
                            <h5 class="card-title">GUI Design</h5>
                             <p class="card-text text-muted">Design a perfect logo accoding to your business.</p>
                            <a href="graphics.php" class="btn btn-success">See More</a>
                        </div>
                    </div>
                </div>
                
                 <div class="col-lg-4 col-md-4 col-sm-12 p-3 offset-lg-4">
                <div class="card sha p-3">
                    <img class="card-img-top" src="img/youtubes.png" alt="Card image cap">
                         <div class="card-body">
                            <h5 class="card-title"> Create Youtube Channle</h5>
                             <p class="card-text text-muted">Create a youtube channel and mantain properly.</p>
                            <a href="youtube.php" class="btn btn-success">See More</a>
                        </div>
                    </div>
                </div>
